...
def test_weather_data_endpoint(test_server):
    ...
    response = requests.get(f"{BASE_URL}/weather/data", params=params)
...
def test_weather_summarize_endpoint(test_server):
    ...
    response = requests.get(f"{BASE_URL}/weather/summarize", params=params)
...
def test_batches_endpoint(test_server):
    ...
    for batch in batches:
        ...
        assert "status" in batch, "Missing 'status' in batch metadata."
